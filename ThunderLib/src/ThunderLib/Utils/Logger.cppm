export module ThunderLib.Logger;
...
export namespace ThunderLib
{
	...
	public:
		...
		{
			LogPreMessage(ThunderLib::LogMessageType::INFO);
			Log(text, FArgs...);
		}
		...
		{
			LogPreMessage(ThunderLib::LogMessageType::WARNING);
			Log(text, FArgs...);
		}
		...
		{
			LogPreMessage(ThunderLib::LogMessageType::ERROR);
			Log(text, FArgs...);
		}
