...
namespace ThunderLib
{
    ...
    void Renderer2D::InitLine() {
        ...
        data.line_vertex_buffer = VertexBuffer::Create(ThunderLib::Renderer2DData::MaxVertices * sizeof(LineVertex));
        ...
        data.line_vertex_buffer_base = new LineVertex[ThunderLib::Renderer2DData::MaxVertices];
    ...
    void Renderer2D::InitCircle() 
    {
        ...
        data.circle_vertex_buffer_base = new CircleVertex[ThunderLib::Renderer2DData::MaxVertices];
